      ...
      <InnerLayout>
        <div className="who">
          ...
          <p>
            ...
            financing to grow their businesses. We believe that business need
            more than finance to succeed. And that growing small businesses to
            create sustainable jobs is the most powerful driver of social and
            economic development that truly improves people’s lives.
          </p>
        </div>
      </InnerLayout>
      ...
      <InnerLayout>
        <div className="journey">
          <div className="journeyText">
            <h1>
              Grow and expand your business with us. A range of easily
              accessible loans
            </h1>
