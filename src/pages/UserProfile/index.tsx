...
function StudentProfile() {
  ...
  const addMemberRow = () => {
    ...
    const _inviteMembers = [...inviteMembers];
    _inviteMembers.push({
      name: "",
      email: "",
      id: uuidv4(),
  ...
  const handleMemberChange = (
    ...
    const _inviteMembers = [...inviteMembers] as any;
  ...
  // handle add team
  const handleAddTeam = () => {
    const _teamsMembers = [...teamsMembers];
    _teamsMembers.push({
      teamName: "",
      id: uuidv4(),
      members: [
  ...
  const handleTeamData = (
    ...
    const _teamsMembers = [...teamsMembers] as any;
              ...
              <div className="input-group">
                ...
                {team.members.map(member => (
                  <div className="form-row" key={member.id}>
                    ...
                    <button onClick={() => addNewMemberInTeam(team.id)}>
                      +
                    </button>
                  </div>
                ))}
